...
def test_users_sync(mocker):
    """
    Given a list of user dictionaries, `users.syc(...)` should create missing users, remove extra non-system users, and update existing users.
    A list of existing usernames can be passed in or default users will be used.
    """
